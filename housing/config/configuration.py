...
class Configuration:
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        try:
            ...
            data_transformation_config_info = self.config_info[DATA_TRANASFORMATION_CONFIG_KEY]
            ...
            preprocessed_object_fle_path = os.path.join(data_transformation_artifact_dir,
